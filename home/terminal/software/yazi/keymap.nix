{
    programs.yazi.keymap = {
        manager.prepend_keymap = [
            ...
            # first-non-directory
            { on = "G"; run = "plugin first-non-directory"; desc = "Jumps to the first file"; }

            # yamb
            { on = "j"; run = "plugin yamb jump_by_key"; desc = "Jump bookmark by key"; }
            { on = [ "b" "a" ]; run = "plugin yamb save"; desc = "Add bookmark"; }
            { on = [ "b" "d" ]; run = "plugin yamb delete_by_key"; desc = "Delete bookmark by key"; }
